...
namespace FaroToLas
{
    public class LasFile
    {
        ...
        public LasFile()
        {
            ...
            mileageFileName = string.Empty;
            shiftFileName = string.Empty;
        }
        public void AddMileage()
        {
            ...
            {
                pr.Z = Convert.ToInt32(sr.ReadLine());
            }
            sr.Close();
            fs.Close();
        }
        public void AddShift()
        {
            ...
            foreach (PointRecord pr in pointRecords)
            {
                pr.UserData = sr.ReadLine().ToCharArray();
            }
            sr.Close();
            fs.Close();
        }
